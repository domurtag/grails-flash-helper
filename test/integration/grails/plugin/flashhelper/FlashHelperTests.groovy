...
public class FlashHelperTests extends GroovyTestCase {
    ...
    void testMsgKeysWithoutArgs() {
        ...
        def fh = getFlashHelper()
        fh.info 'key1'
        assertEquals getMessages(), flash.info[0]

        fh.info 'key2'
        assertEquals getMessages(1..2), flash.info
    }
    ...
    void testMessageSourceResolvableResolution() {
        ...
        assertEquals 'message number 1', flash.info[0]
        fh.clear()
        ...
        assertEquals 'message number arg', flash.info[0]
    }
    ...
    void testArgumentResolution() {
        ...
        assertEquals 'message number key1', flash.info[0]
        fh.clear()
    ...
    void testMsgKeysWithoutArgsWithLocaleAndOrDefaultMsg() {
        ...
        assertEquals frenchMessages[0], flash.info[0]

        fh.info 'key2', frenchLocale
        assertEquals frenchMessages[0..1], flash.info
        fh.clear()
        ...
        assertEquals defaultMsgs[0], flash.info[0]

        fh.info 'badKey2', frenchLocale, defaultMsgs[1]
        assertEquals(defaultMsgs[0..1], flash.info)
    }
    ...
    void testMsgKeysWithArgsAndLocaleAndOrDefaultMsg() {
        ...
        assertEquals(['default msg'], flash.info)
    }
    ...
    void testNamedArgsApi() {
        ...
        assertEquals(["message arg 2", "message arg 3"], flash.info)
    }
    ...
    void testClear() {
        ...
        fh.info(["msg1", "msg2"])
        fh.clear()
        assertEquals 0, flash.size()
    }

    void testMethodChaining() {
        def fh = getFlashHelper().info("infoMsg").warn("warnMsg")

        assertEquals(['infoMsg'], flash.info)
        assertEquals(['warnMsg'], flash.warn)
